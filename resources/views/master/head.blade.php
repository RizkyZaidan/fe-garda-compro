   <head>
       ...
       <!-- App Css-->
       <link href="{{asset('assets/css/now-ui-kit.min.css')}}" id="app-style" rel="stylesheet" type="text/css" />
       <link href="{{asset('assets/css/now-ui-kit.css?v=1.3.0')}}" id="app-style" rel="stylesheet" type="text/css" />
